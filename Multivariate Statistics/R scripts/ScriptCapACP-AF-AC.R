...
plot(res1$x[, 1], res1$x[, 2],
    type = "n", xlab = paste(" CP1  (", (round(100 * sum.res1$importance[2, 1], digits = 1)), " % )"),
...
biplot(a,
    choices = 1:2, pch = 15, cex = 0.8, cex.axis = 0.7, arrow.len = 0.05, xlab = paste(" CP1  (", (round(100 * b$importance[2, 1], digits = 1)), " % )"),
...
AFmv <- factanal(dados, factors = 2, scores = c("Bartlett"), rotation = "varimax")
AFmv
